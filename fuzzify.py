...
# Rules Applied
    rule1 = ctrl.Rule(degree_of_dirt['High'] | type_of_dirt['Fat'], wash_time['very_long'])
    ...
    rule4 = ctrl.Rule(degree_of_dirt['High'] | type_of_dirt['Medium'], wash_time['long'])
    rule5 = ctrl.Rule(degree_of_dirt['Medium'] | type_of_dirt['Medium'], wash_time['medium'])
    rule6 = ctrl.Rule(degree_of_dirt['Low'] | type_of_dirt['Medium'], wash_time['medium'])
    rule7 = ctrl.Rule(degree_of_dirt['High'] | type_of_dirt['NonFat'], wash_time['medium'])
    rule8 = ctrl.Rule(degree_of_dirt['Medium'] | type_of_dirt['NonFat'], wash_time['short'])
    rule9 = ctrl.Rule(degree_of_dirt['Low'] | type_of_dirt['NonFat'], wash_time['very_short'])
